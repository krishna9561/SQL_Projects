...
📘 HealthCare_Data_Analysis SQL Project

This project is a SQL-based HealthCare_Data_Analysis that manages patients, hospitals, diseases, visit history, and billing information.
